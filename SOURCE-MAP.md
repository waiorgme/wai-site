...
| Portal (dashboard, profile, certificate, claim) | `/portal` | `02 Stage 0 - Technical Design (Public Site & Portal)` · `02 PRD Phase 3 - Member Portal` · `02 Member Profile Field Spec (Talent Pipeline)` · `02 Certificates - In-House Engine (Decision)` · `02 Certificate Design & Eligibility Rules (Draft)` · `02 Migration & Claim-Wave Plan (Decision)` · `02 Data Re-Use & Consent at Migration (Decision)` |
