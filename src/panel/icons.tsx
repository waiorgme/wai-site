// Nav glyphs for the workspace shells (Lucide outline paths, inlined like the
// kit's other glyphs so the panel stays dependency-free). 24px viewBox,
// stroke-only, currentColor: they inherit the nav item's resting/active ink.
// Decorative by contract - every caller keeps a text label or aria-label.
