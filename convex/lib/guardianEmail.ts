...
// [she/they] is rendered as "she" (the vault's own convention for members);
// the two bracketed page links resolve to /safeguarding and /privacy, the
// consent button to the tokened confirm page, per the spec. No em dashes.
...
You can read how we protect young members here: ${SITE}/safeguarding/
And how we handle data here: ${SITE}/privacy/

To give your consent, please open the link below and press the confirmation button. If you'd prefer not to, simply ignore this email and the account won't be activated.
